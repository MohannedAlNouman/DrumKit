...
document.querySelector(".j").addEventListener("click", snare);
...
document.querySelector(".k").addEventListener("click", kick);
...
document.querySelector(".l").addEventListener("click", crash);
